...
/**
 * `SecurityUtils` handles all static operations that have to do with
...
public final class SecurityUtils {
    ...
    /**
     * Checks if the current user has been granted access to the given view.
     *
     * @param securedClass
